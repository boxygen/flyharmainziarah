<?php
  ...
  define('APPPATH', __DIR__.'../api/application/');
  // get functions
  ...
  if(isset($_POST['submit'])) {
      ...
      $pass = clean(sha1($_POST['admin_password']));

      $db->query(sprintf("UPDATE pt_accounts SET accounts_email = '$email', accounts_password =  '$pass' WHERE accounts_id = '1' "));
      $db->query(sprintf("UPDATE pt_app_settings SET site_title = '$siteTitle', site_url =  '$domain', license_key =  '$license' WHERE id = '1' "));
          ...
          <ol class="fs-fields">
            <li>
              <p class="fs-field-label fs-anim-upper">
                Welcome to
                <strong>PHPTRAVELS <?php include "../api/application/config/constants.php"; echo "".PT_VERSION; ?></strong> installation! Just fill in the information of this process and get started.
              </p>
            </li>
            <li>
