...
<div class="container">
    ...
    <form action="<?php echo site_url("goflight/invoice"); ?>" method="post" id="booking_form" >
        <div class="row">
            <div class="col-md-8">
                        ...
                        <table style="width: 100%;">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="pull-right"><?php echo $booking_data['departure_time'][$i]; ?></td>
                                </tr>
                                <tr>
                                    <td>Arrival time at <?php echo $booking_data['iataCode_arrival'][$i]; ?></td>
                                    <td class="pull-right"><?php echo $booking_data['arrival_time'][$i]; ?></td>
                                </tr>
                                <tr>
                                    <td>Traveling <?php echo trans('0585'); ?> <?php echo $booking_data['iataCode_arrival'][$i]; ?></td>
                                    <td class="pull-right">
                                        <?php
                                        echo $booking_data['durationtime'][$i];
                                        ?> Hours
                                    </td>
                                </tr>
                            </tbody>
                    ...
                    <?php   if ($booking_data['madult'] > 0) { ?>
                        <table style="width: 100%; padding-bottom: 10px ">
                            ...
                            <tr>
                                ...
                                <td style="text-align: right;"><?php echo $booking_data['currency']." " .$booking_data['currencysymbol'].$booking_data['total']; ?><input type="hidden" name="madult[total]" value="<?php echo $booking_data['total']; ?>"></td>
                            </tr>
                            <tr>
                                <td><?php echo trans('0150')." ".trans('0375'); ?> <?php echo trans('010'); ?></td>
                                <td style="text-align: right;"><?php echo $booking_data['currency']." " .$booking_data['currencysymbol']; echo ($booking_data['madult']*$booking_data['total']);  ?></td>
                            </tr>
                        </table>
                        <hr>
                    <?php } ?>
                ...
                <table class="table table_summary">
                    <tbody>
                        <tr>
                            ...
                            <td class="text-right">
                                <?php echo $booking_data['currency']." " .$booking_data['currencysymbol']. number_format($booking_data['total'],2); ?>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
<script type="text/javascript">
    $("#booking_form").submit(function(e){
        ...
        if (email == cemail) {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo site_url('goflight/invoice/'); ?>',
                dataType: 'json',
                data:form.serialize(),
                beforeSend: function () {
...
i had 3 year experience of APPlications development both IOS & android . web based app and cross platform , Open source code like image processing
