...
<?php  }else{ ?>
    <div class="container booking">
      ...
      <div class="card-body">
        ...
        <div class="bg-white-shadow pt-25 ph-30 pb-40">
            <?php $totalGuests = $payload[2] + $payload[3] + $payload[4]; ?>
            <div class="panel">
                <div class="panel-body">
                    <?php for($i = 1; $i <= $totalGuests;$i++){ ?>
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <label><?php echo trans('0522');?> <?php echo $i;?> <?php echo trans('0524');?></label>
                    ...
                    <div class="bg-white-shadow pt-25 ph-30 pb-40 sticky-kit sidebar-wrapper">
                        ...
                        <?php if($appModule == "flights"){?>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div style="padding: 16px;" class="img-thumbnail">
                                            <img src="<?php if($appModule == "flights") echo PT_FLIGHTS_AIRLINES.$tx->thumbnail;else echo $module->thumbnail; ?>" style="max-width:32px" alt="<?php echo $module->title;?>">
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                            ...
                            <ul class="no-margin no-padding">
                                ...
                                <li><b> Adults  </b> <span class="float-right"><?php echo " (".$flight_lib->currencysign.''.$module->adults .") ".$payload[2] ; ?></span></li>
                            ...
                            <div class="total_table border-bottom mb-20">
                                ...
                                <table style="margin-bottom:0px" class="table table_summary">
                                    ...
                                    <tr class="tr10">
                                        ...
                                        <td class="text-right">
                                            <h5 class="float-none"><?php echo $flight_lib->currencycode;?> <?php echo $module->total_price;?><span id="displaytax"><?php echo $flight_lib->currencysign;?></span></h5>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card mt-3">
                                    ...
                                    <div class="card-body text-chambray">
