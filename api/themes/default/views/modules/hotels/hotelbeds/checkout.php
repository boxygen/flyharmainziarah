...
<div class="container booking">
	...
	<div class="row">
            ...
            <div class="bg-white-shadow pt-25 ph-30 pb-40">
                ...
                <h3 class="heading-title"><?php echo trans('0528');?></h3>
                ...
                <div class="panel panel-default guest">
                <h3 class="heading-title"><?php echo trans('0407');?> <?php echo trans('0177');?></h3>
            ...
            <a href="#" class="product-small-item">
              ...
              <div class="content">
                <div class="content-body">
                  ...
                  <h6><?=$sessionHotel->name?></h6>
                  <div class="clear"></div>
                  <span class="meta text-muted go-right"><i class="ion-location text-info go-right ml-3"></i> <?=$hotel_address.', '.$country_name?></span>
                <div class="clear"></div>
                </div>
              </div>
            </a>
            ...
            <div class="booking-selection-box">
              <div class="content">
                <ul class="clearfix mb-20">
                  <li class="go-text-right"><b> <?php echo trans('07');?><?php echo trans('08');?></b><span class="float-right go-left"><?=$sessionHotel->checkIn?></span></li>
                  <li class="go-text-right"><b> <?php echo trans('09');?><?php echo trans('08');?></b><span class="float-right go-left"><?=$sessionHotel->checkOut?></span></li>
                  <li class="go-text-right"><b> <?php echo trans('0276');?> </b> <span class="float-right go-left"><?=$sessionHotel->totalNights?></span></li>
                  <li class="go-text-right"><b> <?php echo trans('0227');?> </b> <span class="float-right go-left"><?=$sessionHotel->totalRooms?></span></li>
                </ul>
                <div class="clear"></div>
                ...
                <div class="hotel-room-sm-item mb-30">
                  ...
                  <div class="mb-30">
                    <h6 class="rtl-mr-0"><i class="fa fa-bed go-right"></i><?=$sessionHotel->room->name?></h6>
                    <div class="clear"></div>
                    <span class="amount go-right">For <?=$sessionHotel->totalAdults?><?php echo trans('010');?></span>
                     <h5> <?=$sessionHotel->room->rate->boardName?></h5>
                      </div>
                      <div class="clear"></div>
                    <div class="clearfix">
                ...
                <ul class="summary-price-list">
                  <li><?php echo trans('078');?> (incl. VAT)<span class="absolute-right"> <?php $currency = (in_array('hotelCurrency', $sessionHotel->room->rate))?$sessionHotel->room->rate->hotelCurrency:$sessionHotel->currency?></span>
                  <span class="absolute-right" id="displaydeposit"><?=$currency?> <?=$vfHotelbedsMarkup($sessionHotel->room->rate->net + $sessionHotel->room->rate->commission, $markupPercentage)?></span>
                  </li>
                  <div class="clear"></div>
