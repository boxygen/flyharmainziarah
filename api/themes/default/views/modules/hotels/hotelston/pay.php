            ...
            <form  role="form" action="<?php echo base_url();?>creditcard" method="POST">
              ...
              <div class="row">
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" name="bookingid" id="bookingid" value="<?php echo $invoice->id;?>" />
                  <input type="hidden" name="refno" id="refno" value="<?php echo $invoice->agentReferenceNumber;?>" />
                  <input type="hidden" name="hotelname" id="hotelname" value="hotelston" />
