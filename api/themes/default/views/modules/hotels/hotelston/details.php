          ...
          <div class="content-wrapper">
            ...
            <div class="slick-gallery-slideshow detail-gallery">
              <div class="slider gallery-slideshow">
                ...
                <div>
                  <div class="image">
                   <img style="width:100%;max-height: 600px; !important" src="<?=$image->url?>" alt="Images">
                   </div>
                </div>
                <?php endforeach; ?>
              </div>
              <div class="slider gallery-nav slider-thumbnail">
                ...
                <div>
                  <div class="image">
                  <img style="max-height:65px; !important" src="<?=$image->url?>" alt="Images">
                  </div>
                </div>
                <?php endforeach; ?>
              </div>
            ...
            <div id="detail-content-sticky-nav-01" class="fullwidth-horizon-sticky-section">
              ...
              <ul class="main-facility-list clearfix">
                ...
                <li>
                  <span class="icon-font"><i class="ion-checkmark text-primary"></i></span> <?=$amenity->name?>
                </li>
                <?php endforeach; ?>
              </ul>
              <?php endif; ?>
                    ...
                    <div class="col-6 col-md-6 align-self-center">
                      <div class="row gap-20 justify-content-between">
                        ...
                        <div class="col-5 col-sm-4 col-md-4 ml-auto">
                          ...
                          <form action='<?=base_url("hotelst/checkout/".str_replace(' ','-',$hotel[0]->company_name))?>' method="post">
