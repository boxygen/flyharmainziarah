...
<div class="container booking" id="thhotels">
    <div class="row">
        ...
        <div class="success-box d-none d-md-block">
            ...
            <br/>
            <div class="bg-white-shadow pt-25 ph-30 pb-40">
                <form name="bookingForm" action="<?=base_url('hotelsj/booking')?>" method="post">
                    ...
                    <input type="hidden" name="Minimum" value="<?=$room->Minimum?>">
        ...
        <div class="col-12 col-lg-4 order-lg-last">
          <aside class="sticky-kit sidebar-wrapper">
            <a href="#" class="product-small-item">
              <div class="image">
              <img src="<?=$hotel->images[0]->FileName?>" class="img-responsive" alt="hotel image">
              </div>
              <div class="content">
