    ...
    <div class="main-wrapper scrollspy-action">
        <div class="page-wrapper page-confirmation bg-light">
            <div class="container">
                ...
                <?php } else if ($invoice->status == "CAC"){ ?>
                    <div class="success-box unpaid">
                        <div class="icon">
                            <span><i class="ion-close"></i></span>
                        </div>
                ...
                <?php } else if ($invoice->status == "CON"){ ?>
                <div class="success-box">
                    <div class="icon">
                        <span><i class="ion-close"></i></span>
                    </div>
                    <div class="content">
                        <h4><?=lang('0409')?> <?php echo trans("0135"); ?></h4>
                        <p class="go-text-right"><?php echo trans("0410"); ?> <?=$invoice->accounts_email;?></p>
                        <div class="clear"></div>
                    </div>
                </div>
                <?php } else if($invoice->status == "PAG") { ?>
                    <div class="success-box">
                        <div class="icon">
                ...
                <?php } elseif($invoice->status == "PRE") { ?>
                    <div class="success-box">
                        <div class="icon">
                            <span><i class="ion-android-checkbox-outline"></i></span>
                        </div>
                        <div class="content">
                            <h4><?=lang('0409')?> <?php echo trans("0638"); ?></h4>
                            <div class="clear"></div>
                        </div>
                    </div>
                <?php }elseif($invoice->status == "PDI") { ?>
                    <div class="success-box">
                        <div class="icon">
                            <span><i class="ion-android-checkbox-outline"></i></span>
                        </div>
