...
<div class="container booking">
    <div class="row">
        <form name="bookingForm" action="<?=base_url('hotelport/book')?>" method="post">
            <div class="col-md-8">
                <!-- Guests form -->
                <?php $index = 0; ?>
                <?php for($geusts = 1; $geusts <= $_SESSION['adults']; $geusts++): ?>
                <div class="panel panel-primary guest">
                    <div class="panel-heading">Guest <?=$geusts?></div>
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="col-md-6">
                                <label for="first_name"><?php echo trans('0171');?></label>
                                <input type="text" id="first_name" class="form-control" required placeholder="<?php echo trans('0171');?>" name="first_name[]" value="<?=postOldData('first_name', $index)?>">
                            </div>
                            <div class="col-md-6">
                                <label for="last_name"><?php echo trans('0172');?></label>
                                <input type="text" id="last_name" class="form-control" required placeholder="<?php echo trans('0172');?>" name="last_name[]" value="<?=postOldData('last_name', $index)?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-6">
                                <label for="email">Email</label>
                                <input type="email" id="email" class="form-control" required name="email[]" value="<?=postOldData('email', $index)?>" placeholder="<?php echo trans('094');?>">
                            </div>
                            <div class="col-md-6">
                                <label for="phone">Phone</label>
                                <input type="phone" id="phone" class="form-control" required name="phone[]" value="<?=postOldData('phone', $index)?>" placeholder="<?php echo trans('092');?>">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="city" id="city" class="form-control" required name="city" value="<?=postOldData('city')?>" placeholder="City">
                            </div>
                            <div class="col-md-4">
                                <label for="state">State</label>
                                <input type="state" id="state" class="form-control" required name="state" value="<?=postOldData('state')?>" placeholder="State">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-8">
                                <label for="street">Street</label>
                                <input type="street" id="street" class="form-control" required name="street" value="<?=postOldData('street')?>" placeholder="Street">
                            </div>
                            <div class="col-md-4">
                                <label for="postal_code">Postal Code</label>
                                <input type="postal_code" id="postal_code" class="form-control" required name="postal_code" value="<?=postOldData('postal_code')?>" placeholder="Postal Code">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row credit-card__form-container">
                            <div class="col-md-7">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input class="form-control" id="cardNumber" name="cardNumber" type="text" placeholder="xxxxxxxxxxxxxxxx" value="5412675985890474">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-xs-8">
                                        <input type="password" id="cardCVC" required="required" name="cardCVC" class="form-control" placeholder="***" value="900" >
                                    </div>
            ...
            <div class="col-md-4 summary">
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <img src="<?php echo $theme_url; ?>assets/img/hotel.jpg" class="img-responsive" alt="hotel image">
                        </div>
                        <div class="col-md-8">
                            <div class="row">
                                <h6 class="m0"><strong><?=$hotelDetail->RequestedHotelDetails->HotelProperty->name?></strong></h6>
                                <p  class="m0"><?=implode(', ', $hotelDetail->RequestedHotelDetails->HotelProperty->PropertyAddress->Address)?></p>
                            </div>
                        </div>
                    </div>
                    <hr>
                        ...
                        <div class="col-md-12">
                            <div class="hotel_details_panel__checkout">
                                <ul class="no-margin no-padding">
                                    <li><b> <?php echo trans('07');?> <?php echo trans('08');?></b><span class="pull-right"><?=$checkinDate?></span></li>
                                    <li><b> <?php echo trans('09');?> <?php echo trans('08');?></b><span class="pull-right"><?=$checkoutDate?></span></li>
                                    <li><b> <?php echo trans('0276');?> </b> <span class="pull-right"><?=$totalNights?></span></li>
                                    <li><b> <?php echo trans('0227');?> </b> <span class="pull-right"><?=$totalRooms?></span></li>
                                    <li><b> <?php echo 'Total Guests:';?> </b> <span class="pull-right"><?=$adults?></span></li>
                                </ul>
                            </div>
                        </div>
                        <br>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body m0">
                            <p class="m0"><i class="fa fa-bed"></i> <strong><?=$room_name?></strong> <span class="pull-right">For <?=$adults?> <?php echo trans('010');?></span></p>
                            <hr>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <h4>
                                    ...
                                    <div class="pull-right"><strong><?=$roomDetail->Total?></strong></div>
                                </h4>
                            </div>
                        </div>
                        <div class="clearfix"></div>
