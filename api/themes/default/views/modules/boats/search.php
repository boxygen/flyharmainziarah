                    ...
                    <div class="col-lg-2 pr-0">
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="DateTours" class="dateboats form-control" placeholder="dd/mm/yyyy" value="<?=$toursearch['ToursSearchForm']->checkin?>" name="checkin" required>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="col-lg-2 pr-0">
                        <div class="input-box">
                            ...
                            <select class="select-contain-select" name="type" id="boattype">
