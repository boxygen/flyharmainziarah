                                    ...
                                    <div class="col-12 col-md-12">
                                        <div class="map-holder">
                                            <?php  if($appModule == "boats"){
                                                ?>
                                                <iframe id="mapframe" width="100%" height="558" style="position: static; background: #eee;" src="<?php echo base_url();?>boats/boatmap/<?php echo $module->id; ?>" frameborder="0"></iframe>
                                                <script>
                                ...
                                <div class="feature-row">
                                    <div class="row gap-10 gap-md-30">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <p class="go-text-left"><i class="fa fa-sun-o text-success"></i> <strong> <?php echo trans('0275');?> </strong> :   <?php echo $module->boatDays;?> | <i class="fa fa-moon-o text-warning"></i>   <strong> <?php echo trans('0276');?> </strong> :  <?php echo $module->boatNights;?>  | <i class="fa fa-moon-o text-warning"></i>   <strong> <?php echo trans('0441');?> </strong> :  <?php echo $module->boathours;?> </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
