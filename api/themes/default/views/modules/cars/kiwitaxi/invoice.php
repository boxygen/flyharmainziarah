                ...
                <div class="col-12 col-lg-4 order-lg-last">
                    <aside class="sidebar-wrapper pt-30 pb-30 bg-white-shadow">
                        ...
                        <ul class="confirmation-list">
                            ...
                            <li class="clearfix">
                                <span class="font-weight-bold"><?=lang('0211')?> <?=lang('0259')?>:</span>
                                <span><?=$time ?></span>
                            </li>
                        </ul>
                        <div class="mb-40"></div>
                        <ul class="confirmation-list">
                            ...
                            <li class="clearfix">
                                <span class="font-weight-bold"><?=lang('0446')?><!--(2)-->:</span>
                                <span><?=$pax?> <?=lang('010')?>, <?=$child?> <?=lang('011')?></span>
                            </li>
                            <li class="clearfix">
                                <span class="font-weight-bold"><?=lang('0265')?>:</span>
                ...
                <div class="col-12 col-lg-8">
                    <div class="content-wrapper pt-30 pb-30 bg-white-shadow col-12">
                        ...
                        <ul class="confirmation-list">
                            ...
                            <li class="clearfix">
                                <span class="font-weight-bold"><?=lang('0607')?>:</span>
                                <span><?=$pax;?></span>
                            </li>
                            <li class="clearfix">
                                <span class="font-weight-bold"><?=lang('011')?>:</span>
                                <span><?=$child;?></span>
                            </li>
