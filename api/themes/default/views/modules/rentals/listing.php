                ...
                <div class="wrapper-inner">
                  ...
                  <div class="sidebar-box">
                    ...
                    <div class="box-content">
                      ...
                      <div class="clearfix"></div>
                      <?php }else if($appModule == "rentals" || $appModule == "cars"){ ?>
                    ...
                    <div class="col-inner d-flex flex-column">
                      ...
                      <div class="content-bottom mt-auto">
                        <div class="d-flex align-items-center">
                          <div>
                            <p><i class="far"></i><?php echo trans('0631');?>: <?php echo character_limiter($item->rentalType,5); ?> <strong><?php echo trans('0275');?>: <?php echo $item->rentalDays;?>  <?php echo trans('0276');?>: <?php echo $item->rentalNights;?></strong></p>
                          </div>
                          <div class="ml-auto">
...
<div class="listingbg">
  <div class="container offset-0">
    ...
    <div class="col-md-9 col-xs-12">
      <?php if($appModule != "ean" && $appModule != "hotels" && $appModule != "rentals" && $appModule != "cars"){ ?>
      <?php if($appModule == "offers"); {?>
      <?php foreach($module as $item){ ?>
