          ...
          <div class="content-wrapper">
            <div class="post-horizon-wrapper">
              <article class="post-horizon-item blog-single clearfix">
                <?php if($appModule == "offers"){ ?>
                <h3 style="margin: 0px; background: #eee; padding: 15px; text-transform: uppercase; font-size: 18px; letter-spacing: 3px; border: 1px solid #ccc; font-weight: bold;width:100%;" class="text-center"><i class="ion-ios-telephone"></i> <?php echo $module->phone;?></h3>
                <div class="clear"></div>
                <?php } ?>
                <div class="blog-media">
                  <?php foreach($module->sliderImages as $img){ ?>
                  <img src="<?php echo $img['fullImage']; ?>" alt="" width="100%"/>
                  <?php } ?>
                </div>
                <div class="blog-content mt-30">
                  <?php if($appModule != "ean" && $appModule != "hotels" && $appModule != "tours" && $appModule != "cars"){ ?>
                  <h3><?php echo character_limiter($module->title, 28);?></h3>
                  <div class="clear"></div>
                  <?php } ?>
                  <h3 class="heading-title"><?php echo trans('0177'); ?></h3>
                  <div class="clear"></div>
                  <div class="blog-entry">
                    <p><?php require $themeurl.'views/includes/description.php';?></p>
                  </div>
                  <?php if($appModule == "offers"){ ?>
