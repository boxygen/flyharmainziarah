...
(function ($) {
    ...
    $window.on('load', function () {
        ...
        $document.on('click', '.add-flight-btn', function () {
            ...
            if ( $('.multi-flight-field').length < 6 ) {
       ...
       //  hotels 
        ...
        // flights return
        $('.flights_oneway').daterangepicker({ 
            minDate:new Date(), 
            opens: 'right', 
            singleDatePicker: true,  
            autoApply : true, 
        ...
        // flights return
        $('.flights_return').daterangepicker({ 
            minDate:new Date(), 
            opens: 'right', 
            singleDatePicker: false,  
            autoApply : true, 
        ...
        $('.daterentals').daterangepicker({ minDate:new Date(), opens: 'right', singleDatePicker: true,  autoApply : true, format: 'DD-MM-YYYY', locale: { format: 'DD-MM-YYYY' } });
        $('.dateboats').daterangepicker({ minDate:new Date(), opens: 'right', singleDatePicker: true,  autoApply : true, format: 'DD-MM-YYYY', locale: { format: 'DD-MM-YYYY' } });
        $('.datetours').daterangepicker({ minDate:new Date(), opens: 'right', singleDatePicker: true,  autoApply : true, format: 'DD-MM-YYYY', locale: { format: 'DD-MM-YYYY' } });
        $('.datevisa').daterangepicker({ minDate:new Date(), opens: 'right', singleDatePicker: true,  autoApply : true, format: 'DD-MM-YYYY', locale: { format: 'DD-MM-YYYY' } });
       
        $('.date').daterangepicker({ minDate:new Date(), opens: 'right', singleDatePicker: true,  autoApply : true, format: 'DD-MM-YYYY', locale: { format: 'DD-MM-YYYY' } });
