...
class GoibiboflightBack extends MX_Controller
{
    ...
    public function update_settings()
    {
        ...
        $this->App->service("ModuleService")->update('Goibiboflight', 'apiConfig', $payload['apiConfig']);
        redirect(base_url('admin/goflight/settings'));
	}
    ...
    public function bookings()
    {
        ...
        $xcrud->table('pt_goibibo_booking');
        $xcrud->columns(array('firstname','email','phone','country','currency','totalPrice','status'));
        $this->data['content'] = $xcrud->render();
        $this->data['page_title'] = 'Goibibo Booking Management';
        $this->data['main_content'] = 'temp_view';
        $this->data['table_name'] = 'pt_goibibo_booking';
