    ...
    <table class="table table-hover table-striped table-bordered" >
      ...
      <tbody role="alert" aria-live="polite" aria-relevant="all">
        ...
        <tr>
          ...
          <td><a href="<?php echo base_url(); ?>admin/templates/sms/<?php echo $temp->temp_name; ?>"><?php echo $temp->temp_title; ?></a></td>
          <td align="center">
            <a href="<?php echo base_url(); ?>admin/templates/sms/<?php echo $temp->temp_name; ?>"><?php echo PT_EDIT; ?></a>
            <span id="<?php echo $temp->temp_name; ?>" class="btn btn-xs btn-primary sendtotest"><i class="fa fa-envelope"></i> SMS Test</span>
