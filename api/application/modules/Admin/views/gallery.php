                ...
                <div action="<?php echo $uploadUrl.$itemid;?>" id="dropzone" class="dropzone"> </div>
                    ...
                    <table class="table table-striped table-hover">
                        <thead>
                            <tr>
                                <th class="col-md-2">
                                 <a class="btn btn-success" data-bs-toggle="collapse" href="#UploadPhotos" aria-expanded="false" aria-controls="UploadPhotos">
                                  <i class="fa fa-photo"></i> Add Photos
                                 </a>
                                 <div class="clearfix"></div>

                                </th>
                                <th class="col-md-2" style="padding-left:35px" ><input class="pointer all" data-bs-imgname="" type="checkbox" data-bs-toggle="tooltip" data-bs-placement="top"  title="Select All" id="select_all" />  <span data-bs-toggle="tooltip" data-bs-placement="top" title="Delete Selected Images from Table only" class="btn btn-danger btn-xs col-md-9 pull-right delMultiple"><i class="fa fa-trash-o"></i> Delete</span></th>
                        ...
                        <tbody>
                           ...
                           <tr  id="tr_<?php echo $img->id;?>">
                               ...
                               <a href="<?php echo $thumbsDir.$img->image;?>" rel=""> <img src="<?php echo $thumbsDir.$img->image;?>" href="<?php echo $fullImgDir.$img->image;?>" class="img-responsive colorbox"></a>
                                ...
                                <td style="padding:35px"><input type="checkbox" data-bs-imgname="<?php echo  $img->image;?>" name="img_ids[]" value="<?php echo  $img->id;?>" class="checkboxcls"  /></td>

                                <td style="padding:35px">
                                    <input class="form-control" type="number" id="order_<?php echo $img->id;?>" onblur="updateOrder($(this).val(),<?php echo $img->id;?>,<?php echo $img->imgorder;?>)" value="<?php echo $img->imgorder;?>" data-bs-url="<?php echo $imgorderUrl;?>" >
                                </td>
                                <?php if(!empty($showactive)){ ?>
                                <td style="padding:35px">
