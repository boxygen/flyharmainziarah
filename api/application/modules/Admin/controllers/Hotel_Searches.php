...
class Hotel_Searches extends MX_Controller {
   ...
   function index() {
    ...
    $xcrud->table('hotels_search_logs');
    $xcrud->order_by('id','desc');

    $this->data['content'] = $xcrud->render();
    $this->data['page_title'] = 'Hotels Search Management';
    $this->data['main_content'] = 'temp_view';
    $this->data['table_name'] = 'hotels_search_logs';
    $this->data['main_key'] = 'id';
    $this->data['header_title'] = 'Hotels Search Management';
