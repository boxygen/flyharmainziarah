...
class Tours_Bookings extends MX_Controller {
    function __construct() {
        modules :: load('Admin');
        $this->load->model('Admin/Tours_Bookings_model');
   ...
   function index() {
    ...
    $this->data['all_booking'] = $this->Tours_Bookings_model->admin_get_tour_bookings($booking_status,$booking_payment_status);
        $this->data['main_content'] = 'bookings';
        $this->data['page_title'] = 'Tours Bookings View';
