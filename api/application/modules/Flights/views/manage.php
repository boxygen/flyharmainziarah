...
<style>
    ...
    .select2-container .select2-choice { height: 43px; line-height: 2.2; }
</style>
                                        ...
                                        <table class="table table-striped table-bordered" cellspacing="1" bgcolor="#cccccc">
                                            <tbody>
                                                ...
                                                <tr bgcolor="#ffffff" style="text-align:center">
                                                    <td>Price</td>
                                                    <td><input type="text"   class="form-control input-sm adult"  name="adultprice[]" id="" size=""  value="<?=$mainArray[$index]->price->adultprice?>"></td>
                                                    <td><input type="text" class="form-control input-sm child"  name="childprice[]" id="" size=""  value="<?=$mainArray[$index]->price->childprice?>"></td>
                                                    <td><input type="text" class="form-control input-sm infant"  name="infantprice[]" id="" size=""  value="<?=$mainArray[$index]->price->infantprice?>"></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <table class="table table-striped" id="t1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:130px">Flight Time</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        ...
                                        <tr id="template" class="template_class">
                                            ...
                                            <th><input type="" class="form-control flights_class"  id="flight_no" name="flightnos_<?=$type?>[]" placeholder="Flight No" value="<?php echo $mainArray[$index]->flight_no[$i]; ?>" style="width:100px"/></th>
                                            <!--<th> -->
                                            <script>
                                            $('#flight_no').change(function() {
                                                $('.flights_class').val($(this).val());
                                            });
                                            </script>
                                            <input class="form-control dpd3 date_class<?=$i?>" type="hidden"  placeholder="Optional Date" value="<?php if($mainArray[$index]->dates[$i] == "00/00/0000")echo "";else echo $mainArray[$index]->dates[$i];?>" name="date_<?=$type?>[]" >
                                            <!--</th>
                                                <input name="times_<?=$type?>[]" type="hidden" required placeholder="Check In" class="form-control timepicker time_click0  clockface-open"  data-format="hh:mm A" value="02:30:00" />-->
                                            ...
                                            <th><input name="times_<?=$type?>[]" type="text" required placeholder="Time" class="form-control timepicker time_click1  clockface-open"  data-format="hh:mm A" value="<?php echo $mainArray[$index]->times[$i];?>" /> </th>
                                ...
                                <div class="row form-horizontal">
                                    <div class="col-md-6">
                                        <div class="form-group" style="display:none">
                                            ...
                                            <div class="col-md-4"><input type="" class="form-control" placeholder="Depart Time" /> </div>
                                            <div class="col-md-4"><input type="" class="form-control" placeholder="Arrival Time" /> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                                ...
                                <div class="card p-5">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-8">
                                                <select  class="form-select" name="flightstatus">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label class="col-md-4 control-label text-left">Bagage KGs</label>
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                     <input type="text" required  class="form-control" name="bagage" value="<?php if(!empty($bagage)){ echo $bagage;}?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-4 control-label text-left">Total Hours</label>
                                            <div class="col-md-8">
                                                <div class="input-group">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label class="col-md-4 control-label text-left">Vat Tax</label>
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                    <input type="text"  class="form-control" name="tax" value="<?php if(!empty($tax)){ echo $tax;}?>">
                                                    <span class="mx-3 input-group-addon">%</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-4 control-label text-left">Deposite</label>
                                            <div class="col-md-8">
                                                <div class="input-group">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label class="col-md-4 control-label text-left">Class</label>
                                            <div class="col-md-8">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label class="col-md-4 control-label text-left">Refundable</label>
                                            <div class="col-md-8">
                                        ...
                                        <div class="form-group" style="display:none">
                                            <label class="col-md-4 control-label text-left">Direction</label>
                                            <div class="col-md-8">
                            ...
                            <div class="col-md-8">
                                <div class="panel panel-default">
                                    ...
                                    <div class="mb-3">
                                   <button id="<?php echo $submittype; ?>" class="btn btn-primary mdc-ripple-upgraded" type="submit"> <i class="leading-icon material-icons">save</i> Update </button>
                                </div>
                                </div>
                            </div>
                        </div>
