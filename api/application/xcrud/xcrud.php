...
class Xcrud
{
        ...
        '&uarr; ', 'desc' => '&darr; '))
    {
        ...
        $out .= $this->open_tag($item)."<input onchange='select_all_data(this)' class='".Xcrud_config::$selectAllClass."' type='checkbox' value='' id='select_all' > ".$this->close_tag($item);
        if ($this->is_numbers)
        {
    ...
    protected function add_button($class = '', $icon = '')
    {
        ...
        {
            $ab = $this->render_button('add', 'create', '', $class, $icon) ;
            return $ab;
        }
    }
